...
inoremap <buffer> ,it <em></em><Space><++><Esc>FeT>i
inoremap <buffer> ,1 <h1></h1><Enter><Enter><++><Esc>2kf<i
inoremap <buffer> ,2 <h2></h2><Enter><Enter><++><Esc>2kf<i
inoremap <buffer> ,3 <h3></h3><Enter><Enter><++><Esc>2kf<i
